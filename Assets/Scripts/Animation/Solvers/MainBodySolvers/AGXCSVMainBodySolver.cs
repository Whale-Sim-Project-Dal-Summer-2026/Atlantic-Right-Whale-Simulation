...
/// <summary>
///  hhook up ball thing
/// hook up the timestep 
/// hook up reset 
/// </summary>
public class AGXCSVMainBodySolver : MainBodySolverAbstract {
    ...
    public AGXCSVMainBodySolver(float fixedTimeStepIn, WhaleState startState, AGXUnity.RigidBody rb){
    ...
    private Global_AnimationData classicMainBodySolve ( MotionDataPacket currentPacket, Global_AnimationData previousState){
        ...
        Vector3 forward = newState.Rotation * (Vector3.forward *6);
